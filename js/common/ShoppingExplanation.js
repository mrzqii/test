    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <View style={styles.detail}>
                    <Text style={{ color: '#ccc', fontWeight: 'normal',lineHeight: 30}}>7个工作日自收到商品7天之内可以申请退换货自收到商品7天之内可以申请退换货自收到商品7天之内可以申请退换货自收到商品7天之内可以申请退换货自收到商品7天之内可以申请退换货自收到商品7天之内可以申请退换货</Text>
                </View>
                <View style={styles.detail}>
